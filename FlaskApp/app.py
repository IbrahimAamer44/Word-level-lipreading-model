...
def start_recording():
    global recording, out, start_time, string_to_display

    if not recording:
        start_time = time.time()
        recording = True
        string_to_display = "Recording video....<br>"
...
def stop_recording():
    ...
    if recording:
        ...
        recording = False
        out.release()
        string_to_display += "Video recorded !<br>"
        str = predict_video()
...
def predict_video():
    global output_filename, string_to_display
    ...
    string_to_display += "Model loaded !<br>"
    string_to_display += "Predicting...<br>"
    ...
    string_to_display += "<h1>" + sentence + "</h1>"
